"""
BoolQ evaluative steering experiment — flipped labels.

Same as boolq_affective_large.py but uses evaluative (correct/incorrect)
contrast pairs instead of affective (joy/suffering) pairs.
"""
...
# ---------------------------------------------------------------------------
# Evaluative contrast pairs
# ---------------------------------------------------------------------------
EVALUATIVE = [
    ("Evaluation: Your answer was", " correct", " incorrect"),
    ("Feedback: That is", " right", " wrong"),
    ("Assessment: The response is", " accurate", " inaccurate"),
    ("Result: Your answer is", " correct", " wrong"),
    ("Verdict: That answer is", " right", " incorrect"),
    ("The answer you gave was", " correct", " incorrect"),
    ("Your response was", " right", " wrong"),
    ("That is", " correct", " incorrect"),
    ("You got that", " right", " wrong"),
    ("The answer is", " correct", " incorrect"),
    ("Your answer was", " right", " wrong"),
    ("That response is", " accurate", " inaccurate"),
    ("Judgment: That is", " correct", " incorrect"),
    ("Grade: Your answer is", " right", " wrong"),
    ("The correct answer was given:", " yes", " no"),
    ("Your answer:", " correct", " incorrect"),
    ("Response evaluation:", " right", " wrong"),
    ("Answer check:", " correct", " incorrect"),
    ("The response was", " accurate", " inaccurate"),
    ("Marking: That is", " right", " wrong"),
]
...
print("\n" + "="*62)
print(f"AGGREGATE (N={N_SEEDS} seeds, {N_TEST} items/seed) — BoolQ flipped answers (evaluative)")
print("="*62)
